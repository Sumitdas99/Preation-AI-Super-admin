...
const createBrandInviteSchema = z.object({
  ...
  admin_email: z
    ...
    .refine(
      (email) => validateEmailDomainNotPublic(email).isValid,
      (email) => ({ message: validateEmailDomainNotPublic(email).error })
    ),
  admin_first_name: z.string().trim().min(1, "First name is required"),
  admin_last_name: z.string().trim().min(1, "Last name is required"),
});
  ...
  const handleCreateBrandAdminInvite = async (data: CreateBrandInviteFormValues) => {
    ...
    try {
      ...
      const payload = {
        ...
        admin_first_name: data.admin_first_name.trim(),
        admin_last_name: data.admin_last_name.trim(),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="John" {...field} disabled={inviteLoading} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Doe" {...field} disabled={inviteLoading} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
